...
const coordenadores = {
    ...
    "Elisa Carvalho de Siqueira": { email:"elisa.siqueira@animaeducacao.com.br", cursos:["Odontologia","Design de Interiores","Design Gráfico","Design Gráfico (Semipresencial) 30/70"] },
    "Elizabeth Rodrigues Brito Ibrahim": { email:"elizabeth.ibrahim@animaeducacao.com.br", cursos:["Arquitetura e Urbanismo","Farmácia","Farmácia (Semipresencial) 30/70","História","Pedagogia","Pedagogia (Semipresencial) 30/70"] },
    "Marcos Ferreira Benedito": { email:"marcos.benedito@animaeducacao.com.br", cursos:["Enfermagem","Jornalismo","Publicidade e Propaganda"] }
};
