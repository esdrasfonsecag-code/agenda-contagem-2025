...
// Agenda (mantive simples, você pode expandir)
const dias = [
    {nome: "Segunda-feira", horarios:["Marcos Ferreira Benedito — 08:00 às 12:00","Ana Paula dos Santos Gomes — 08:30 às 12:30"]},
    {nome: "Terça-feira", horarios:["Elizabeth Rodrigues Brito Ibrahim — 13:00 às 17:00","Ana Amelia Fonseca Viana Cruz — 08:30 às 12:30"]},
    {nome: "Quarta-feira", horarios:["Elisa Siqueira — 08:00 às 13:00"]},
];
...
const coordenadores = [
  ...
  },
  {
    ...
    cursos: ["Administração","Ciências Contábeis","Ciências Econômicas","Comércio Exterior","Educação Física","Gestão Comercial"]
  }
];

// Função gerar botão de email como ícone
...
// Renderiza coordenadores e cursos
